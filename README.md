...
- hit " npm start " in the cmd/backend
...
- create a project name as todoListApp or Frontend
...
- create or copy the code from todoListAPP/app/index.tsx in your frontend folder

Note- In your index.tsx code
- set  const API="http://YOUR_LAPTOP_IP:5000" 
- hit ipconfig in cmd to get the ip off your LAPTOP

- now run " npx expo start " in your cd todoListApp/ or Frontend/ in cmd
...
- After Download scan the QR code from the cmd appears after the command " npx Expo start" while running frontend
